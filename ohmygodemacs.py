...
# save the contents of the following docstring as ohmygodemacs.elsip in your
# User directory
#
...
"""
;; ohmygodemacs.elisp
;; ex: emacs --no-site-file -batch contents.html -l ohmygod.elisp -f emacs-format-function
